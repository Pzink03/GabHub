...
const GridUsersList = ({ users }: GridUsersListProps) => {
  ...
  return (
    <ul className='grid-container'>
        {users.map((user) => (
            <li key={user.$id} className='min-w-80 flex flex-col justify-center items-center gap-4 bg-light-2 border border-primary-500 hover:shadow-lg rounded p-10'>
                    ...
                    <h1 className="text-center md:text-xl w-full text-black font-bold mt-2">
                        {user.name}
                    </h1>
